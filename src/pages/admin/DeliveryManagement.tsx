...
import { Truck, MapPin, Clock, User, Navigation, Search } from 'lucide-react';
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Heure d'assignation</TableHead>
                  ...
                  <TableRow key={order.id}>
                    ...
                    <TableCell>
                      <div className="flex items-center space-x-2">
                        ...
                        <span>{deliveryPerson?.display_name || 'Non assigné'}</span>
                      </div>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <Button
                        ...
                        variant="outline"
                        onClick={() => {
                          // Ici on pourrait ouvrir une modal avec les détails du tracking
                          console.log('Voir détails tracking pour:', order.id);
                        }}
                      >
                        Suivre
                      </Button>
